            ...
            <Box className={classes.selectitem} style={{ marginTop: "6px" }}>
              {type === "order" ?
                ...
                >
                  ...
                  <MenuItem value="Block">Farmer</MenuItem>
                  <MenuItem value="Active">Deleivery Partner</MenuItem>
                </Select> : <Select
                  variant="outlined"
                  fullWidth
                  onChange={(e) => setStatus(e.target.value)}
                  value={status}
                >
                  <MenuItem value="Block">Published</MenuItem>
                  <MenuItem value="Active">UnPublished</MenuItem>
                </Select>
              }
            </Box>
          </Grid>
          {/* {type !== "collection" && type !== 'scheme' && (
            <Grid item lg={3} md={3} sm={4} xs={12}>
              <Box className={classes.selectitem} style={{ marginTop: "6px" }}>
                <Select
                  variant="outlined"
                  ...
                  value={status}
                >
                  <MenuItem value="Block">Registration</MenuItem>
                  <MenuItem value="Active">Last Order</MenuItem>
                </Select>
              </Box>
            </Grid>
          )} */}
